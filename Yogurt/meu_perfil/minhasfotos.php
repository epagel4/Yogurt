...
<div class="container mt-5 justify-content-center bg-light col-xl-6 mb-5" style="border-radius: 10px;">
				<div class="row">
					...
					<!--<h3 class="text-primary ml-auto text-right m-3 col-3"><a href="../meu_perfil/minhasfotos.php" data-toggle="modal" data-target="#modalimg"><i class="fas fa-file-image fa-2x"></i></a></h3>-->
				</div>
