...
<html lang="pt-br">
  <head>
    ...
    <title>Yogurt - Home</title>
    <link rel="icon" href="v1../img/logo1.png">
  </head>
					...
					<div class="col-10">
						<div class="row">
							<div class="col mt-1">
						        ...
						        <span id="qtd_likes"></span> 
      							<a href="javascript:curtir(10);">
						        <i class="far fa-thumbs-up"></i>
						        </a>

								<!--<a href="curtida.php?acao=like&postagem=<?php echo $result[$i]['id'];?>" role="button" class="text-muted align-middle" style="text-decoration: none"><i class="far fa-heart text-muted"></i><span class="align-top"><?php //if($curtida){ echo count($curtida);} else { echo 0;} ?></span></a>-->
